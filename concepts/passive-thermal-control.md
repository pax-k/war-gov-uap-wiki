...
- **GT-7 1965 Borman bogey** ([[references/sighting-gemini-7-bogey-1965-12-04]]) — Gemini-class spacecraft did not perform PTC; the bogey is a **single-bearing single-witness** call. ^[inferred]
- **Apollo 12 d1 Bean AOT particle-flash** ([[references/nasa-uap-d1-apollo-12-transcript-1969]]) — Bean's observation was through the LM's AOT (a fixed-mount instrument), not through cabin windows during PTC; Apollo 12's d1 LM/CSM rendezvous configuration was **not** in PTC. ^[inferred]
