...
source_path: _raw/ (declassified UAP archive volumes)
sources: [_raw/18_6369445_general_1948_vol_1.json]
summary: Personal research project distilling declassified primary-source UAP / Flying Disc archives into a structured wiki — starts with USAF 1948 Project SIGN material.
provenance:
  extracted: 0.5
  inferred: 0.5
  ambiguous: 0.0
...
- **Primary sources**: declassified US government bundles dropped into `_raw/` and processed by `wiki-ingest`.
...
- [[concepts/horten-flying-wing]] — German wartime tailless aircraft as the leading conventional explanation.
...
| Date | Location | Page |
|---|---|---|
| 5–8 March 1948 | Bakersfield, CA | [[references/sighting-bakersfield-1948-03]] |
