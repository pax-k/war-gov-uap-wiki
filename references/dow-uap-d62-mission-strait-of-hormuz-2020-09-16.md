...
- ~~**Test for further d63+ 482ATKS missions in Sep-Oct 2020** — d60 + d61 + d62 are 38 days apart across Aug 8 → Aug 27 → Sep 16. Does the queue contain a d63 / d64 / etc with 482ATKS attestation in late-Sep or Oct 2020? If so, the same-unit cluster extends. If not, the d60+d61+d62 triplet is the closed cluster. ^[inferred]~~ ^closed-by-dow-uap-d63 — **CLOSED (positive)**: [[references/dow-uap-d63-mission-strait-of-hormuz-2020-10-02|d63]] (1-2 Oct 2020, Misrep 4871281) is a fourth 482ATKS / 432 AEW MQ-9 NAVCENT-support mission, **16 days after d62 / 55 days after d60**. **Cluster extends to N=4 quadruplet across 55 days Aug-Oct 2020**. 29-of-31 unit/platform/tasking axes byte-for-byte match (2 axes diverge at POC + APPROVER rank — d63 introduces tier-3 A1C/Capt pairing vs d60+d61 tier-1 1st Lt/1st Lt vs d62 tier-2 SSgt/SrA, indicating squadron rotates at least 3 distinct aircrew+approver pairings). Open thread persists for d64+ in late-Oct/Nov 2020. ^[inferred]
...
- ~~**Test EMI-event recurrence in dow-uap corpus** — d62 is the first EMI-event-bearing artifact. Does the EMI segment recur within or outside the 482ATKS cluster? If recurrent, the EMI segment is canonical in the USMTF Misrep schema; if isolated to d62, it is the within-cluster outlier akin to d61's formation-track. ^[inferred]~~ ^closed-by-dow-uap-d63 — **CLOSED (negative)**: [[references/dow-uap-d63-mission-strait-of-hormuz-2020-10-02|d63]] (1-2 Oct 2020, same 482ATKS / 432 AEW MQ-9 same NAVCENT-support tasking same Arabian Gulf-Hormuz-Oman theater, 16 days after d62) carries **zero EMI events**. EMI is now **isolated at N=1 (d62 alone) at N=4 full-Misrep ingests** — the within-cluster outlier reading is confirmed, akin to d61's formation-track. The d62-anchored "EMI as canonical USMTF Misrep schema axis" reading is **superseded** in favor of **EMI as conditional / event-specific segment**: the USMTF Misrep schema permits EMI segments when EMI events occur but EMI is not a per-mission feature. ^[inferred] Iranian-EW-emission attribution for d62's EMI events further isolates to d62-only and weakens the sustained-Iranian-EW reading.
...
- ~~**Test the GUARDCALL DIRECTIVE-tone recurrence pattern** — d62 introduces DIRECTIVE tone at hails #1 + #2; does DIRECTIVE tone recur in future ingests, or is it d62-isolated? If recurrent, the GUARDCALL tone is a per-event variable correlated with controller individual / airspace severity. ^[inferred]~~ ^closed-by-dow-uap-d63 — **CLOSED (positive)**: [[references/dow-uap-d63-mission-strait-of-hormuz-2020-10-02|d63]] carries 5 GUARDCALL events, **2 of them DIRECTIVE** (hail #3 at 1122Z FL160 + hail #5 at 1315Z FL160) interleaved with 3 PROFESSIONAL. **DIRECTIVE tone recurrence anchored at N=2 missions (d62 + d63)** — it is not d62-isolated. Across 10 total hails in the cluster (d60+d61+d62+d63 = 1+1+3+5), DIRECTIVE tone runs at 4-of-10 (~40%) — DIRECTIVE is a recurring per-event variable in multi-hail missions, not a one-off escalation. ^[inferred]
