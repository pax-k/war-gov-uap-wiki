---
title: "FBI HQ File 62-HQ-83894 — Section 10 (Serials 448-486)"
category: references
tags: [uap, fbi, primary-source, declassified]
sources: [sources/65_hs1-834228961_62-hq-83894_section_10.json]
summary: 184-OCR-page tranche of FBI HQ 62-HQ-83894 covering serials 448-486, ~6 Sep 1966 → 14 Jun 1977 — the file's longest single span and effective terminus, including Project Blue Book closure (Dec 1969), the Condon-Committee press echo, and the Carter-era White House coordination question.
provenance:
  extracted: 0.6
  inferred: 0.37
  ambiguous: 0.03
...
The **tenth section** of [[entities/fbi-hq-62-83894-file|FBI HQ file 62-HQ-83894]] — **184 OCR pages** indexed serials **448 through 486** ^[extracted], spanning **6 September 1966 → 14 June 1977** ^[extracted] (date stamps on individual filings). This is the **16th of 17** ingested artifacts in the wiki series for the file, and pending the missing **section 6**, this section is the **file's effective terminus** ^[inferred] — the last filing in the OCR is the 14 Jun 1977 Cochran → McDermott memo on the **Carter White House inquiry** (serial 486), with no later 1977 or 1978 material visible in the ingest.

The section opens with serial 448 — Hoover's 6 Sep 1966 reply to **Mrs. Levi J. Dow** (Goffstown NH), enclosing the **AFSCA "Flying Saucers International" Issue No. 24 (Jul 1966) plus 3rd National Convention flyer** that Mrs. Dow had forwarded with a CP-line concern. ^[extracted] The section closes ~10.8 years later with the **Cochran-Schneider 1977 White House inquiry** ([[references/fbi-cochran-schneider-1977]]) — the first **post-Blue-Book executive-branch coordination question** in the file. ^[inferred]

## Filing-block / processing metadata

- **Class–Case–Sub–Vol filing**: `62-HQ-83894 SERIALS 448-486`. ^[extracted]
- **Cover slip**: *"02-HQ-83894-10 / FBI - CENTRAL RECORDS CENTER / HQ - HEADQUARTERS / Class 0062 Case 83894 Sub 10 Serial 448 OPEN"* ^[extracted]
- **Processing tag**: `8/11/1274176`. ^[extracted]
- **FOIPA copy**: `APR 26 1971 BY 2310` (cover-slip stamp) — same FOIPA-pre-1974 internal-copy pattern observed in [[references/fbi-hq-62-83894-section-9|section 9]] (May 1971). ^[extracted]
- **Cover slip note**: *"USE CARE IN HANDLING THIS FILE / Declassification authority derived from FBI Automatic Declassification Guide, issued May 24, 2007"*. ^[extracted]
- **NARA/NND project**: Multiple page-level *"DECLASSIFIED PER EXECUTIVE ORDER 12958, SECTION 3.5 NND PROJECT NUMBER: NND 785010 BY: NND DATE: 1978"* stamps on field-office enclosures (e.g. Dallas serial 464). ^[extracted] The 1978 declassification predates the section's nominal close-out by only one year, suggesting **rolling declassification** during file accumulation. ^[inferred]

## Content map (serials 448-486)

The 184 OCR pages decompose into **~39 distinct filings** along the **same five recurring channel types** established for [[references/fbi-hq-62-83894-section-9|section 9]] ^[inferred], plus **two new structural elements** unique to section 10: ^[inferred]

| Channel | Description | Examples in section 10 |
|---|---|---|
| **(d) Field-office filings to HQ** | SAC airtels/letters routing inbound civilian saucer correspondence to HQ | Philadelphia/LA on AFSCA issue 24 (448-449), Miami serial 460 (Peyerl), Dallas serials 463-464 (anonymous ETI informant), Dallas serial 465 (NICAP subcommittee), Cincinnati 477, San Antonio serial 479 (Ozanne) |
| **(b) Hoover form-letter responses** | Outbound replies from Hoover (or after May 1972, post-Hoover Directors) | Dow 448, Hennessy 453, Thorn 454, Dyer 461, Hullett 462, Ankerich 463, Edwards 466, Stewart 470, Cerame 471, Stephens 473, Brassington 475, Steckling-via-Cantine 477 |
| **(j) USAF-OSI bidirectional referrals** | OSI/AF referrals routed back to FBI | implicit in Dallas Cooper-AF crosshair (453), Bureau letter to Tinker AFB (465 enclosure cc) |
| **Annual self-review (h)** | NONE in section 10 — the [[concepts/fbi-saucer-policy-stasis-1958-1962|annual-review chain]] does not resume ^[inferred] | (absent — last review is 1962) |
| **Sub rosa subject files** | Bryant 481 (1974), Wood 472 (former-CIA self-report), Ozanne 479 (impostor) | as listed |
| **NEW (l) — Post-Blue-Book Fact-Sheet enclosure** | OSI-channel transmittal of the 1969-termination Fact Sheet **back into** the FBI file via 1977 routing | McClanahan → Malmfeldt 14 Jan 1977 letter + UFO Fact Sheet, filed 62-HQ-83894-483 + Moore reply 484 |
| **NEW (m) — White-House coordination inquiry** | EOP/OSTP → FBI inquiry on inter-agency UFO coordination | Schneider → Cochran phone 14 Jun 1977 + Cochran-McDermott internal memo 14 Jun 1977 + Cochran-Schneider 15 Jun 1977 reply, all filed 62-HQ-83894-486 |

The section's intake-channel inventory therefore grows from **12 to 14**, and the parent file's lifetime channel inventory closes (pending section 6) at **14 distinct intake channels**. ^[inferred]

## Master serial table (serials 448-486)

| Serial | Date | Channel | Counterparty / topic | OCR pp |
|---|---|---|---|---|
| **448** | 6 Sep 1966 | (b) | **Mrs. Levi J. Dow** (Goffstown NH) — encloses [[entities/amalgamated-flying-saucer-clubs-of-america\|AFSCA]] *Flying Saucers International* Issue No. 24 (Jul 1966) + 3rd National Convention flyer (Reno NV, 8-10 Jul 1966); Hoover form-letter response | 1-29 |
| **449** | 3 Oct 1966 | (d) | LA SAC → Director on AFSCA — see [[references/fbi-hq-62-83894-serial-449]] (already ingested standalone) | 30 |
| 450 | 24 Oct 1966 | (b) | **John Moss** (free-lance writer) — TV-show inquiry on identity of "Mel Noel" (named AFSCA convention speaker); FBI declines | 30 |
| 451 | 28 Oct 1966 | (k)/(d) | **Newsweek 31 Oct 1966 issue** clipping — AF awards $300K Univ of Colorado contract to **[[concepts/condon-committee\|Dr. Edward U. Condon]]**; the FBI clips the *Newsweek* coverage of the Condon Committee's launch | 30-31 |
...
| **460** | 8 Jun 1967 (interview 26 Apr 1967) | (d) | **[[references/fbi-peyerl-black-forest-1967\|Paul L. Peyerl]]** (Eastern Airlines mechanic, Miami; ex-Luftwaffe test pilot, ex-British POW) walks into Miami FO with WW2 Black-Forest "saucer-shaped 21-foot radio-controlled" aircraft photo + KUEHR engineer attribution + N₂H₄O/CH₃OH "fuel-mix" data; "feels such a weapon would be beneficial in Vietnam" | 54-69 |
| 461 | 18 Jul 1967 | (b) | **Mrs. Lyle Dyer** (Sumter SC) — Hoover form-letter | 70-71 |
| **462** | 22 Aug 1967 | (b) + (d) | **Theodore Gray Hullett** (San Francisco) — Hoover-birthday letter ("Walter Winchell" sign-off) enclosing entire **[[concepts/contactee-movement-1952-1954\|UFO CONTACT igap journal Vol 2 No 5 (Jun 1967)]]**, dedicated to Adamski; ~50 OCR pages of the Adamski-continuation movement (Steckling Belgium tour, Madeleine Rodeffer NASA visit, Petersen "Out of the clear blue sky", "Open Letter to Queen Juliana of the Netherlands"); Bureau policy disclaimer reply | 72-99 |
| **463** | 3 Oct 1967 | (b) | **R. Charles Ankerich** (Atlanta GA) — Hoover form-letter (post-Project-Mogul-style ball-lightning hypothesis context) | 100 |
| **464** | 9 Oct 1967 | (d) | **[[references/sighting-dallas-anonymous-eti-1967\|Dallas Anonymous Informant]]** — young white female walks into Dallas FBI office; claims contact with extraterrestrial in human form (Jul-Aug 1967), ETI shootdown over "Dewline" Aug 1967, antimissile vs. UFO over Africa May 1962, UFO 22,000 mi from Earth Aug 1967, UFO over Antarctica Aug 1967 | 100-103 |
| **465** | 23 Jan 1968 (encl 20 Nov 1967) | (d) | **[[entities/nicap\|NICAP]] Dallas-Ft Worth subcommittee formation** — Robert G. Edwards (Texas Unit #2) writes formal briefing letter to FBI describing NICAP's structure, the **Colorado Project** (begun Nov 1966 under USAF contract), and the subcommittee's request for sighting tips | 110-112 |
| **466** | 19 Mar 1968 | (b) | **Glenn Evans** ("United Saucer Hunter Organization", Waterloo IL) — asks if FBI captured a saucer occupant per a flying-saucer-magazine photo; Hoover denies; same photo "two FBI Agents leading a person from outer space down the street" filed at 466 + later 475 | 113-115 |
| 467 | 1968 | (b) | Hoover form-letter (correspondent unknown OCR) | 116-117 |
| 468-469 | mid-1968 | (b) | Linked routing — Stewart 470 enclosure (Harvard College Observatory letter to Stewart, 28 Jul 1964, identifies bright meteor as bolide) | 118-130 |
| 470 | 1968-69 | (b) | **Edward A. Stewart Jr.** (Mt Holly NJ) — letter referenced via 1964 Harvard Observatory bolide-attribution chain | 130 |
| **471** | 7 May 1969 | (b) | **Lon M. Cerame** ("Eastern Representative, National Investigations Committee on Unidentified Flying Objects" — note: NICOUFO, *not* NICAP) — preparing AF magazine article; Hoover form-letter | 131-134 |
| **472** | 16 May 1969 | (e)/(d) | **Forrest E. Wood** (Compton CA), self-claimed ex-CIA agent, telephones Bureau 12:50am drunk and *"recently discharged as a patient from the psycho ward of a Veteran's hospital"*, requests Hoover call him on UFO sightings; CIA liaison check via SA Papich = no record | 135-136 |
| **473** | 21 May 1969 | (b) | **Larry Stephens** (Del City OK) — asks FBI about **MIB rumor** "men with oriental features wearing dark clothes go around terrorizing UFO witnesses … impersonated armed forces officers and FBI investigators … black or dark automobiles … attempted to run down witnesses … silenced several investigators … opened mailer, tapped telephones" — see [[concepts/three-men-in-black]]; Helen W. Gandy form-letter reply | 137-142 |
| **474** | 7 Aug 1969 | (e)/(h) | **J. A. Hennessey** Liaison Confidential summary memo — three-year retrospective on Hennessey's correspondence pattern with FBI; FBI-internal counterintelligence note via Washington Representative routing channel | 143 |
| **475** | 13 Oct 1969 | (b) | **Paul Brassington / Stephen Smith / Gary Hargreaves** ("UFO Astronomer Club", Ajax Ontario; ages 13/13/12) — write asking if photo of "supposedly man from outer space being held by two FBI agents" is genuine; Hoover sends 3× *Story of the FBI* + 3× *99 Facts* | 144-148 |
| 476 | mid-1969 | (b) | Hoover form-letter (correspondent unknown OCR) | 149-152 |
| 477 | Oct 1969 | (b) | Hoover form-letter; 12-line message length | 153-155 |
| 478 | Oct 1969 | (b) | Hoover form-letter | 156-157 |
| **479** | 20 Mar 1973 | (d) | **Dave T. Ozanne impostor case** — man wearing AF uniform with chaplain's badge, carrying folder marked Top Secret with photos of military installations, posing as USAF Captain inquiring at Waco TX newspaper re local UFO sightings; San Antonio FO files for information; first FBI-corpus civil-impostor UFO case ^[inferred] | 158-162 |
| **480** | 25 Oct 1973 | (b) | **Ron Fraide** (La Habra CA) — first **post-Hoover** Director-signed UFO form-letter in the file ([[entities/clarence-m-kelley\|Clarence M. Kelley]]) | 163-165 |
| **481** | 15 Apr 1974 | (b)/(j) | **[[entities/larry-w-bryant\|Larry W. Bryant]]** (Arlington VA) — first formal civilian-records request invoking [[concepts/saucer-as-hoax-default\|FOI/privacy-spirit]]; cites Pres Nixon's privacy assurance + ACLU cc; Bureau confirms Castles 17 Sep 1963 interview for **first time on record** + agrees to send copies of prior correspondence; resolves long-standing Section 9 open question | 166-170 |
| **482** | 22 Aug 1974 | (e)/(d) | **[[references/sighting-milwaukee-fallen-object-1974\|Milwaukee unidentified-object-fall case]]** — NMCC (Major Horn) calls FBI Command Center 12:07am asking for info; Milwaukee Police Captain Wills recovered 13×8×5" metallic jagged object with *"internal heat source"* at 5:55pm 8/21/74; FBI relays back to NMCC; UPI coverage same morning; second physical-object recovery in FBI corpus after section 8's Houston Blevins | 171-172 |
| **483** | 17 Jan 1977 | (l) NEW | **Lt Col H. A. McClanahan** (USAF Chief Civil Branch) → **Mr. Malmfeldt** (FBI Room 7825) — encloses the **[[references/fbi-blue-book-termination-fact-sheet-1977\|UFO Fact Sheet]]** documenting Project Blue Book's 17 Dec 1969 termination + Total UFO Sightings 1947-1969 chart + UFO-related materials list (Univ of Colorado scientific study, NAS panel review); the Fact Sheet is the **canonical FBI-side artifact of the [[concepts/project-blue-book-termination-1969\|1969 Blue Book termination]]** ^[inferred] | 173-178 |
| **484** | 24 Jan 1977 | (l) NEW | **Donald W. Moore Jr.** (FBI Asst Director, External Affairs) → McClanahan thanking him for the Fact Sheet "and for apprising us of the termination of your project" — the FBI's first formal acknowledgement of Blue Book closure on the file's record ^[inferred] | 179 |
| 485 | 15 Jun 1977 | (m) NEW | Cochran-Schneider letter (no separate serial number visible — sent from Cochran to Schneider enclosing Feb 1975 FBI Law Enforcement Bulletin UFO article) | 181 |
| **486** | 14 Jun 1977 | (m) NEW | **[[references/fbi-cochran-schneider-1977\|Stanley Schneider]]** (OSTP, EOP) → **Jay Cochran Jr.** (FBI Asst Director, Technical Services) telephone inquiry — *"Jody Powell of the President's staff has raised the question as to whether or not there is any coordination within the Executive Branch relating to information concerning this subject"*; Cochran-McDermott internal memo same day; first **post-Blue-Book executive-branch coordination question** in the FBI corpus ^[inferred] | 182 |

## HEADLINE — section 10 contains the file's documentation of Project Blue Book termination + the Carter-era post-termination coordination question
...
The **17 December 1969 Blue Book termination** rescinds AFR 80-17 (the AF regulation governing UFO investigation), transfers all documentation to NARA Modern Military Branch, and **removes the institutional anchor** that the FBI's saucer policy has been pegged to since BB-57 (Oct 1947) — *"all reports … should be referred to the Air Force"*. ^[inferred] After 17 Dec 1969 the *"Air Force"* in the FBI's standard-policy disclaimer is referencing an Air Force that no longer investigates UFOs. ^[inferred] The disclaimer-without-mechanism continues anyway through Kelley (1973-77) and Cochran (1977). ^[extracted]

## Other paradigm-shaping content

- **The Peyerl Black-Forest WW2 saucer disclosure** (serial 460, Jun 1967) — see [[references/fbi-peyerl-black-forest-1967]]. Connects to [[concepts/horten-flying-wing]] / [[synthesis/horten-thesis-vs-disc-sightings]]: a former Luftwaffe test pilot walks into a US FBI field office in 1967 with a 1944 saucer-shaped-aircraft photograph + KUEHR engineer attribution + chemical-fuel data, motivated by [[concepts/saucer-as-hoax-default|recent UFO publicity]] and his desire that the *"weapon … would be beneficial in Vietnam"*. ^[extracted] First FBI-corpus walk-in saucer disclosure tied to **WW2 German aerospace engineering**. ^[inferred]
- **The Dallas Anonymous Informant ETI claims** (serial 464, Oct 1967) — see [[references/sighting-dallas-anonymous-eti-1967]]. Young white female walks into Dallas FBI office, refuses to give name, claims direct contact with an extraterrestrial in human form (Jul 1967), claims ETI departed Earth 21 Aug 1967, claims four specific UFO events known to her via "non-earthly sources" — including UFO shootdown over the **DEW Line**. The Dallas SAC files the LHM as 62-83894-464 with copy to OSI Tinker AFB. ^[extracted] First FBI-corpus walk-in claim of **active ongoing telepathic ETI contact**. ^[inferred]
- **The Forrest Wood ex-CIA self-claim** (serial 472, May 1969) — first FBI-corpus instance of a citizen claiming **prior CIA service** as credentialing for a UFO complaint. ^[inferred] CIA liaison response (SA Papich): no record. ^[extracted]
- **The Larry Stephens MIB rumor query** (serial 473, May 1969) — see [[concepts/three-men-in-black]] (UPDATED). The MIB myth has now matured into a **reflexive citizen-FBI query**: people write the FBI to ask whether the FBI itself is the MIB. ^[inferred] Stephens's enumeration (oriental features, dark clothes, dark cars, run-down attempts, mail-tampering, telephone taps, photographs of UFO-witness homes) is a structurally complete inventory of the 1969 MIB folklore.
- **The Brassington / Smith / Hargreaves Ontario boys' query** (serial 475, Oct 1969) — three Canadian children (ages 12-13) ask the FBI to confirm or deny a magazine photo *"two FBI agents leading a person from outer space down the street"*. ^[extracted] Hoover sends FBI promotional material; Bureau notes the photo originally appeared in a German publication. ^[extracted] Same photo had been the subject of Glenn Evans's earlier Mar 1968 letter (serial 466). The Stephens 473 / Brassington 475 pair shows the **MIB and saucer-occupant-FBI photo myths circulating in international civilian-research-circle in 1968-1969**. ^[inferred]
- **The Ozanne impostor case** (serial 479, Mar 1973) — first FBI-corpus instance of **civil impersonation of an Air Force Captain inquiring about UFOs while carrying a falsely-marked Top Secret folder of military-installation photos**; San Antonio FO files for information without arresting (no unlawful activity suspected). ^[inferred]
- **The Milwaukee fallen object** (serial 482, Aug 1974) — see [[references/sighting-milwaukee-fallen-object-1974]]. NMCC calls FBI Command Center at 12:07am inquiring about a 13×8×5" metallic jagged object with *"internal heat source"* recovered by Milwaukee Police; FBI relays back to NMCC. **Second physical-object recovery in the FBI corpus** (after the section-8 Houston Blevins case). ^[inferred]

## Structural observation — the post-Hoover regime

J. Edgar Hoover dies **2 May 1972**, mid-section-10. ^[inferred — historical background] His signature appears on serials 448-473 (Sep 1966 - May 1969) plus the standard *"J. Edgar Hoover / John Edgar Hoover / Director"* form-letter pattern through 1969. By 25 Oct 1973 (serial 480) the signing Director is **[[entities/clarence-m-kelley|Clarence M. Kelley]]**. ^[extracted] The 24 Jan 1977 reply on Blue Book termination (serial 484) is signed by **Donald W. Moore Jr.** (Asst Director, External Affairs) — the form-letter functions are now distributed across multiple Asst Directors rather than centralized at the Director. ^[inferred]

The **Hoover-era Helen Gandy form-letter pattern** — visible since section 1 — runs through serial 473 (Stephens 1969) and disappears thereafter. ^[inferred] Section 10 is the file's documentation of the **transition from the Hoover-monolith to the post-Hoover distributed-Asst-Director Bureau**. ^[inferred]

## What section 10 does NOT contain

Three notable absences ^[inferred]:
...
The [[concepts/fbi-saucer-policy-stasis-1958-1962|annual saucer-policy review chain]] (serials 392, 422, 425, 427) does not resume in section 10. ^[inferred] The likely explanation: ^[inferred]

- **The reviews' purpose was to memorialize that BB-57 + AF-11/12/57-assurance remained the standing policy.** When the AF terminates Project Blue Book in Dec 1969, the AF-assurance anchor disappears and the review's standing-frame collapses. ^[inferred]
- **No replacement review chain emerges in 1969-1977.** The file's content during this period is reactive (correspondence handling) rather than proactive (institutional self-review). ^[inferred]
- **The Cochran 1977 memo to McDermott (serial 486)** functions structurally analogously to the annual reviews — it restates the FBI's standing posture for the AD-level record (16 cc's, including each Asst Director) — but is event-driven (White House inquiry), not annual-cadence. ^[inferred]

## File terminus assessment
...
- **What was in the 1975 FBI Law Enforcement Bulletin February issue UFO article** that Cochran enclosed for Schneider in serial 485? ^[open] The article exists outside the FBI HQ 62-HQ-83894 file but is referenced by it.
- **Did Bryant pursue a follow-up FOI request after the 15 Apr 1974 reply (serial 481)** that fell into a different file (62-115530, the FOI-REPLIES bufile)? ^[open]
- **What was the publication-channel for Mrs. Dow's "Indian Squaw" letter (serial 448)** and was it ever republished? ^[ambiguous]

## Sources

- `sources/65_hs1-834228961_62-hq-83894_section_10.json` (184 OCR pages, ~39 distinct filings)
- See also: [[entities/fbi-hq-62-83894-file]], [[references/fbi-hq-62-83894-section-9]], [[references/fbi-hq-62-83894-serial-449]]
- [[concepts/project-blue-book-termination-1969]], [[concepts/condon-committee]], [[concepts/post-bb-uap-coordination-question-1977]]
- [[references/fbi-peyerl-black-forest-1967]], [[references/sighting-dallas-anonymous-eti-1967]], [[references/sighting-milwaukee-fallen-object-1974]], [[references/fbi-cochran-schneider-1977]], [[references/fbi-blue-book-termination-fact-sheet-1977]]
- [[concepts/three-men-in-black]] (extended for 1969 reflexive-FBI-query)
- [[concepts/contactee-movement-1952-1954]] (extended for post-1965 Adamski-continuation movement)
- [[entities/larry-w-bryant]] (extended for 1974 records-request resolution)
