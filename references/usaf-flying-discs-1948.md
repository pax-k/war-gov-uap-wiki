---
title: USAF Flying Discs Correspondence — 1948 Vol 1, Doc 18
category: references
...
A 28-page bundle of Mistral-OCR'd USAF inter-office memoranda spanning February through June 1948. The file documents how the early USAF routed civilian and military "Flying Disc" sighting reports up its intelligence chain during the opening months of [[concepts/project-sign]].

## What the bundle contains

- A standing directive from [[entities/c-p-cabell|Maj Gen C. P. Cabell]] (27 Feb 1948, AFOIR-CO-5) laying out the [[concepts/flying-disc-reporting-protocol|10-element observational template]] every Air Force installation must use when filing a sighting report.
- The "Project SIGN" clippings/intel summary referrals from Air Intelligence Requirements Division to [[entities/air-materiel-command|Air Materiel Command]] at [[entities/wright-patterson-afb|Wright-Patterson AFB]].
- Field reports on specific incidents — see [[references/sighting-bakersfield-1948-03]] and [[references/sighting-hobson-ohio-1948-05]].
- Material on the [[concepts/horten-flying-wing|Horten flying wing]] hypothesis, including a US drawing called the "[[references/loedding-flying-disc|Loedding Flying Disc]]" (LD-2), an RAE technical note (AERO 1703), and a T-2 report titled "German Flying Wings Designed by Horten Brothers" (F-SU-1110-HD).
- A March 1948 exchange between Director of Intelligence and Director of Plans & Operations rejecting AMC's proposal to put fighter aircraft on continuous alert at every base for disc interception. ^[extracted]

## Key actors named

- [[entities/c-p-cabell|C. P. Cabell]] — Major General, Chief of Air Intel. Req. Div., Directorate of Intelligence
- George C. McDonald — Major General, Director of Intelligence, Office of Deputy Chief of Staff, Operations
- H. M. McCoy — Colonel, Deputy Commanding General Intelligence (T-2), [[entities/air-materiel-command|AMC]]
- S. E. Anderson — Major General, Director of Plans and Operations
- Lt Col George D. Garrett, Jr. — Acting Chief, Collection Branch, Air Intelligence Requirements Division (the routing officer named on most documents in the file)
- Col Robert Taylor (III) — Chief, Collection Branch
- Lt Col Douglass W. Eiseman — Executive, Air Intelligence Requirements Division
- Lt Col Wilton H. Earle, Jr. — Executive, Air Materiel Requirements Division

## Notable incident threads

| Date of sighting | Location | Source memo |
|---|---|---|
| 5–8 March 1948 | Bakersfield / Buena Vista Lake, CA | [[references/sighting-bakersfield-1948-03]] |
| 8 May 1948 (night) | Hobson, OH | [[references/sighting-hobson-ohio-1948-05]] |
| Earlier 1948 incidents | Tyndall AFB FL; 4th Air Force CA; 10th Air Force TX; Canada | mentioned via routing slips, full reports not in this bundle |

## Provenance notes

The file appears to be page 18 of "general_1948_vol_1" — strongly suggesting a numbered series of declassified UAP archive volumes. ^[inferred]
The Mistral OCR pass preserves the "CONFIDENTIAL" / "SECRET" / "RESTRICTED" classification stamps as inline text — these are declassification artifacts, not active markings. ^[extracted]
