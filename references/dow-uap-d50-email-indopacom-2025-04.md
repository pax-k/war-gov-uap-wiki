...
- **Map d51's place** — d51 (also `*-email-correspondence-*`) is queued. If d51 carries OUSD(I&S) attribution and 12 AF / DET 3 or 15 AF / DET 1 unit anchors, the email-correspondence class is internally consistent on both axes at N=3. If d51 introduces a third unit / third role, the variability widens.
