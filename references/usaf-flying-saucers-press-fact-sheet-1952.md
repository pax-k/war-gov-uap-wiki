---
title: "USAF/DOD-OPI Flying Saucers Press Fact Sheet, ~Sep 1952"
category: references
tags: [uap, primary-source, declassified, usaf, policy]
aliases: [DOD-OPI saucer fact sheet 1952, AF press fact sheet flying saucers 1952, Albert Chop fact sheet]
sources: [sources/65_hs1-834228961_62-hq-83894_section_7.json]
summary: ~September 1952 mimeographed Department of Defense Office of Public Information fact sheet on the Air Force's flying saucer investigations — the standardized public-facing posture distributed to journalists in 1952.
provenance:
  extracted: 0.7
  inferred: 0.27
  ambiguous: 0.03
...
# USAF/DOD-OPI Flying Saucers Press Fact Sheet (~Sep 1952)

A **mimeographed press fact sheet** prepared by the **Department of Defense Office of Public Information** and distributed by **Albert Chop (DOD-OPI)** to journalists during the 1952 saucer wave — the **standardized public-facing position** of the US government on UAP, retained in [[references/fbi-hq-62-83894-section-7|FBI HQ 62-HQ-83894 section 7]] serial 320 (pages 70-72) as a 4-page enclosure to a Pentagon memo. ^[extracted]

## What the fact sheet says

The fact sheet is structured around 7 narrative beats ^[extracted]:
...
### 2. Project Saucer launch (30 Dec 1947)
...
### 3. December 1949 termination announcement
...
### 4. Continuation as ATIC normal-intelligence-function (1949 →)
...
### 5. Statistics (~1500 reports investigated, ~20% unexplained)
...
### 6. Source distribution (civilian vs military vs scientific)
...
### 7. The "What 'Saucers' Are Not" closing statement
...
The closing **categorically denies the foreign-state-weapon, US-secret-experiment, AND interplanetary-ship hypotheses simultaneously** ^[extracted] — a structurally definitive public-facing posture statement. ^[inferred]

## Sub-sections of analytical content

The fact sheet also addresses ^[extracted]:

- **Difficulty in evaluating reports** — based on insufficiency of size/shape/composition/flight-characteristics data.
- **Radar sightings** — temperature inversion reflections; ionized clouds; thunderstorm activity; many radar signals later identified as aircraft, birds, balloons, ice formations.
- **The Oak Ridge January 1951 case** — F-86 interceptors got radar lock on object that "first led upward and then down toward a specific point on the ground" — interpreted as **temperature inversion artifact**.
- **Policy regarding interception** — *"No orders have been issued by the Air Defense Command to its fighter units to fire on unidentified aerial phenomena."* ^[extracted]
- **Methods of evaluation** — collect data → check against known objects → unexplained reports go to specialists.
- **Future plans** — **diffraction-grating camera** + **Schmidt telescope with continuous photography** — proposed instrumentation for systematic data collection. ^[extracted]
...
- The fact sheet is **the document Albert Chop gave Daniel Lang** for the [[references/lang-new-yorker-1952-09-06|6 Sep 1952 New Yorker article]] — the *"some routine items of interest regarding flying saucer complaints and investigations by the Air Force"* Chop admitted supplying. ^[inferred]
- **The 1500-report / 20%-unexplained statistics** become the canonical public-facing quantitative anchor through 1952-69 and reappear in the BLUE BOOK conclusion. ^[inferred]

## Open threads

- **Date the fact sheet precisely** — section 7 indicates *"Recd from Mr Albert Chop Office of Public Info, OSD - 10/6/52 WMP"*. The fact sheet itself is undated. ^[open]
- **Identify the Oak Ridge January 1951 case** referenced — distinct from the 1-8 March 1950 [[references/sighting-oak-ridge-adcock-1950-03|Adcock case]]. ^[open]
- **Track the diffraction-grating camera + Schmidt telescope program** — was this implemented by ATIC after 1952? ^[open]
- **Track Albert Chop's post-1952 trajectory** — by 1956 Chop was reportedly working with Capt Ruppelt's UFO book project. ^[ambiguous]

## See also

- [[references/fbi-hq-62-83894-section-7]] — primary source (serial 320 enclosure, pages 70-72)
- [[references/lang-new-yorker-1952-09-06]] — public-facing journalistic catalog informed by this fact sheet
- [[concepts/project-grudge]] — predecessor AF project (terminated Dec 1949)
- [[concepts/robertson-panel-runup-1952]] — synchronous CIA-IAC institutional engagement
- [[references/fbi-bureau-bulletin-57-1947]] — analogous FBI passive-intake instrument
- [[references/fbi-sac-letter-83-1952]] — synchronous FBI public-posture reaffirmation
- [[references/fbi-boggs-hearn-discontinuation-memo-1950-03-28]] — December 1949 termination's institutional anchor
- [[references/sighting-oak-ridge-adcock-1950-03]] — earlier (Mar 1950) Oak Ridge case
