...
- **Validate full-Misrep document class at N≥3** — ^closed-by-dow-uap-d62. [[references/dow-uap-d62-mission-strait-of-hormuz-2020-09-16|DoW-UAP-D62]] (15-16 Sep 2020, Misrep 4782130) is the **third full-Misrep with 9 substantive pages + same complete USMTF segment set** — class CONFIRMED at N=3 across 38-day same-unit-same-tasking triplet d60+d61+d62. Still **same-unit (482ATKS) attestations at all 3 anchors** — the question of whether the class persists beyond 482ATKS to a Navy-unit full Misrep (e.g. F/A-18 or P-8A) remains open at N=3; the `GENTEXT/OBSERVATION` segment-name distinction reading 1 (curator-renamed at release) vs reading 2 (originating-service convention) remains observationally compatible since all 3 anchors are USAF MQ-9. ^[inferred]
- **Test for d62+ as another 482ATKS / 432 AEW August-2020 mission** — ^closed-by-dow-uap-d62. **The same-unit cluster extends to N=3 triplet** with [[references/dow-uap-d62-mission-strait-of-hormuz-2020-09-16|DoW-UAP-D62]] (15-16 Sep 2020, **20 days after d61, 38 days after d60**) — same 482ATKS / 432 AEW MQ-9 ^[inferred] / same NAVCENT support / same operation 1.4a / same theater / same OKAS launch / 29-of-31 unit-tasking axes byte-for-byte match (2 axes diverge at POC + APPROVER rank — d62 SSgt + SrA enlisted vs d60+d61 1st Lt commissioned, indicating different aircrew within same squadron rotation ^[inferred]). The cluster extends from Aug-only to **Aug-Sep 2020 across 38 days**; the 482ATKS deployment ran sustained NAVCENT-support tasking with at least 3 missions producing UAP observations. Open thread persists for d63+ in later Sep-Oct 2020. ^[inferred]
...
- **Test the ninth brief-observation sub-class at N≥2** — **REFRAMED at d62 ingest**: [[references/dow-uap-d62-mission-strait-of-hormuz-2020-09-16|d62]] does NOT extend sub-class 9 — d62's UAP datum (FMV + single object + no kinematics + no morphology + no duration + no PID-loss) matches **d60's sub-class 8 (bare FMV-observation + zero-mission-impact + kinematics-blank + morphology-blank)**, NOT d61's formation-track sub-class. At N=3 of full-Misrep UAP datums, **sub-class 8 firms to N=2 (d60+d62) as the dominant brief-observation mode within the 482ATKS cluster**; **sub-class 9 d61-formation-track is isolated at N=1 as the within-cluster outlier**, not the establishing case. ^[inferred] The 9-sub-class taxonomy on [[concepts/uap-aircraft-engagement]] remains correct at the type-level; only the relative anchor weights within the dow-uap full-Misrep sub-class shift — d61's formation signature is a single 2-minute deviation within a same-unit cluster that predominantly produces bare-FMV brief observations.
...
- [[references/dow-uap-d62-mission-strait-of-hormuz-2020-09-16]] — **Third FULL USMTF Misrep (Misrep 4782130, 15-16 Sep 2020); same 482ATKS / 432 AEW MQ-9 ^[inferred] / same NAVCENT support / same operation 1.4a — third member of the corpus's first same-unit-same-tasking triplet (38-day Aug-Sep 2020 span), 20 days after d61**; confirms full-Misrep document class at N=3 ^closed-by-dow-uap-d62; **reframes d61's sub-class 9 (formation-track) as within-cluster outlier** — sub-class 8 (d60+d62 bare FMV-observation) is the dominant brief-observation mode at N=2 within 482ATKS cluster; sub-class 9 d61 isolated at N=1. d62 anchors EMI events as NEW canonical USMTF Misrep schema axis (2 MEDIUM-impact lost-link events with paired GENTEXT/EMI + JSIR ID330412+330414 + first §1.4(g) classifications); 3 Iranian GUARDCALLs at d62 (first DIRECTIVE tone, first multi-hail mission, first same-MGRS multi-hail cluster); second explicit PAROC at 12 AF / DET 3 (with d61) decisively resolves d50 PAROC-vs-PAROL ambiguity ^closed-by-dow-uap-d62; Block B triples to 3-of-8 (d38+d61+d62)
