...
- [[references/dow-uap-d60-mission-persian-gulf-2020-08-08]] — **First FULL USMTF Misrep parent document** in dow-uap corpus (8 Aug 2020 Arabian Gulf / Strait of Hormuz / Gulf of Oman 482ATKS / 432 AEW MQ-9 ^[inferred] NAVCENT-support); shares **Block A release-framework** with d55 (Harrison + MDR `26-0038 to 26-0046` + AARO + `03/27/26`); **both are NAVCENT-supported** (d55 = P-8A / TF 67.1 Russian-Kuznetsov CTG; d60 = MQ-9 NAVCENT-support over Iranian-airspace-adjacent Strait of Hormuz). d60 closes the `000001` open question at d55 — per-document page-sequence-number reading confirmed.
- [[references/dow-uap-d58-range-fouler-debrief-2020-10]] — Range-fouler debrief, Block A release framework twin
- [[references/dow-uap-d44-range-fouler-arabian-sea-october-2020]] — Range-fouler debrief, Block A release framework
- [[references/dow-uap-d56-range-fouler-arabian-sea-august-2020]] — Range-fouler debrief, Block A release framework; **first internal Navy user (HSM-73 MH-60R)** ^[inferred] — extends the dow-uap Navy-anchor count from d55 (P-8A / TF 67.1 fixed-wing) to **2 Navy platform anchors** (d55 fixed-wing + d56 rotary-wing)
- [[references/dow-uap-d38-range-fouler-middle-east-may-2020]] — Range-fouler debrief carrying the **distinct Block B release framework** (`MDR 26-0019` + `01/26/26 001`); now isolated at 1-of-6 release-block-testable artifacts vs Block A at 5-of-6
