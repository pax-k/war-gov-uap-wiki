...
- [[references/dow-uap-d51-email-pacific-time-zone-2023-03]] — **Third email-correspondence artifact** ^closed-by-dow-uap-d51 (firming-with-bifurcation class on d50's "d51 will validate or widen at N=3" thread) — Mar 2023 civilian-witness Pacific Time Zone sighting near a national security facility; AFOSI OSI CI ↔ OUSD(I&S) IDA derivative-classification review of UNCLASS summary of an AFOSI IIR. **d51 bifurcates the email-correspondence class at N=3** — sub-class A (d52 + d50: IDAT-originated tearline-clearance, Misrep parent) vs sub-class B (d51: OUSD(I&S)-originated derivative-classification-review, AFOSI IIR parent). **Firms d52's `NA` (North America) reading at N=2** within the class via d51's CONUS Pacific-Time-Zone placement (INDOPACOM isolated at 1-of-3, d50 only). **OUSD(I&S) attestation at N=3 cross-document** but with role inversion (reviewer at d52 + d50; originator at d51). **First civilian witness + first ground-based observation + first AFOSI institutional anchor + first IIR parent document class** in the dow-uap corpus.
