...
|---|---|---|---|
| Reentry, 19 Dec 1972 | Reentry-plasma "fireball" tunnel-and-bright-spot wake through rendezvous window | [[entities/ronald-evans\|Evans]] | [[references/nasa-apollo-17-technical-crew-debriefing-1973]] |
| Recovery, 19 Dec 1972 | Aircraft-carrier superstructure misidentified through fogged window ("tin can") | [[entities/gene-cernan\|Cernan]] (recounting Evans) | [[references/nasa-apollo-17-technical-crew-debriefing-1973]] |
| Transearth coast, ~16–19 Dec 1972 | Continuous cosmic-ray retinal light flashes when dark-adapted; one possibly on lunar surface; flashes vanish during ALFMED blindfolded interval | [[entities/harrison-schmitt\|Schmitt]] | [[references/nasa-apollo-17-technical-crew-debriefing-1973]] |

None of the three observations is a UAP report. The artifact is the **orbital-class structural analogue** of the diplomatic-channel **[[concepts/figurative-ufo-rhetoric|figurative-UFO rhetoric]]** boundary cases — material that enters the FOIA UAP-keyword release universe without UAP narrative payload. ^[inferred]

## Mission profile (overview)

- **Launch vehicle**: Saturn V (AS-512). ^[inferred]
- **Launch**: 7 December 1972, 05:33 UTC, Kennedy Space Center LC-39A. ^[inferred]
- **Landing site**: Taurus-Littrow valley. ^[inferred]
- **Lunar surface duration**: ~75 hours; three EVAs by Cernan + Schmitt with the Lunar Roving Vehicle. ^[inferred]
- **CMP solo activity**: Evans remained in lunar orbit aboard CSM *America* and conducted the SIM-bay scientific instrument observations. ^[inferred]
- **Recovery**: 19 December 1972, **USS Ticonderoga (CV-14)** in the Pacific. ^[inferred]
...
- Locate the **complete MSC-07631 Apollo 17 Technical Crew Debriefing** (the corpus has only page 24-4 plus the cover sheet). ^[open]
